...
var a = {hola: "cristia", camilo: "vasquez"}
var encrypt = unescape(encodeURIComponent(JSON.stringify(a)))
var encoded = Base64.encode(encrypt)
console.log(encoded)

var decoded = Base64.decode(encoded)
var parsed = JSON.parse(decodeURIComponent(decoded)) 
console.log(parsed.hola)