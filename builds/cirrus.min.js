...
h){var k=h.split("#");return renderResponse(k[0],k[1],wApp,c.extension||c.headers.Accept)}var l=getHTML("/views"+c.url);return""!==l.html?renderResponseAssets(l,"text/html; charset=utf-8"):"HTTP/1.0 404 NOT FOUND"}catch(m){switch(m.name){case "SyntaxError":return renderErrorResponse(m,"Unable to parse JSON string");default:return c=logError(m),renderErrorResponse(m,c)}}}
