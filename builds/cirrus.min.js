...
function renderResponseAssets(c,e,d){d=d.isWindows()?c.html:unescape(encodeURIComponent(c.html));var f=["Date: "+(new Date).toGMTString(),"Content-Length: "+d.length];c.useCache&&(f.push("Cache-Control: max-age="+c.maxAge),f.push("ETag: "+c.eTag));f=f.concat(BasicHeaders).concat(["Content-Type: "+e]);return"HTTP/1.0 200 OK\r\n"+f.join("\r\n")+"\r\n\r\n"+d}
