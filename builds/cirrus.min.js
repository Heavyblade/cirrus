...
function renderResponse(c,e,d,f){var g=f.extension||f.headers.Accept,h=void 0!==d[c].authentication&&"object"==typeof d[c].authentication,l=-1<((d[c].authentication||{}).actions||[]).indexOf(e)||(d[c].authentication||{}).all;if(h&&l&&(void 0===f.headers.Authorization||!1===isAuthorized(d[c],f)))return renderUnauthorized(d[c].authentication.namespace);void 0!==d[c].before&&"function"==typeof d[c].before&&(d.router.params=d[c].before(d.router.params));f=void 0!==d.router.params.redirect_to?d.router.params:
d[c][e](d.router.params);g=g||"json";f.redirect_to&&(g="redirect");g=g.match(/(html|xml|json|redirect)/i)||["json"];c=Engine[g[0]](f,d,c,e);e=["Date: "+(new Date).toGMTString(),"Content-Length: "+(c.body?c.body.length:"0")];e=e.concat(BasicHeaders).concat(c.headers).concat(d.responseHeaders.buildForHTTP());wApp.session.changed&&e.push(wApp.session.setInHeader());return c.verb+"\r\n"+e.join("\r\n")+"\r\n\r\n"+c.body}
var Engine={json:function(c,e){var d=void 0!==c.responseCode&&void 0!==c.responseCode.code&&void 0!==c.responseCode.message?"HTTP/1.0 "+c.responseCode.code+" "+c.responseCode.message:"HTTP/1.0 200 OK";delete c.responseCode;var f=e.router.params.callback;c=f?f+"("+JSON.stringify(c)+")":JSON.stringify(c);c=e.isWindows()?c:unescape(encodeURIComponent(c));return{verb:d,body:c,headers:["Content-Type: application/"+(f?"javascript":"json")+"; charset=utf-8"]}},html:function(c,e,d,f){if("object"==typeof c){var g=
