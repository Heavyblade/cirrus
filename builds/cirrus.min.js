...
(e=f.bodyDecoded[body[1]],h=wApp.getType(decodeURIComponent(body[2])),void 0===e?f.bodyDecoded[body[1]]=h:("object"!=typeof e&&(f.bodyDecoded[body[1]]=[e]),f.bodyDecoded[body[1]].push(h)));return f}
