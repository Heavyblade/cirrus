...
(e=decodeURIComponent(body[1]),h=f.bodyDecoded[e],k=wApp.getType(decodeURIComponent(body[2])),void 0===h?f.bodyDecoded[e]=k:("object"!=typeof h&&(f.bodyDecoded[e]=[h]),f.bodyDecoded[e].push(k)));return f}
