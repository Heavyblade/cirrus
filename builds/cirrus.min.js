...
function renderResponse(c,d,e,f){var g=f.extension||f.headers.Accept;void 0!==e[c].authentication&&"object"==typeof e[c].before&&(e[c].authentication.actions||[]).indexOf(d);void 0!==e[c].before&&"function"==typeof e[c].before&&(e.router.params=e[c].before(e.router.params));f=void 0!==e.router.params.redirect_to?e.router.params:e[c][d](e.router.params);g=g||"json";f.redirect_to&&(g="redirect");g=g.match(/(html|xml|json|redirect)/i)||["json"];c=Engine[g[0]](f,e,c,d);d=["Date: "+(new Date).toGMTString(),
"Content-Length: "+(c.body?c.body.length:"0")];d=d.concat(BasicHeaders).concat(c.headers).concat(e.responseHeaders.buildForHTTP());wApp.session.changed&&d.push(wApp.session.setInHeader());return c.verb+"\r\n"+d.join("\r\n")+"\r\n\r\n"+c.body}
