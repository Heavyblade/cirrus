...
b=void 0;a=wApp.cookie_name+"="+a;void 0!=b&&(a+="; expires="+b.toGMTString());void 0!=c&&(a+="; path="+c);return"set-Cookie: "+a},getSession:function(a){var b={},c={},d=wApp.cookie_name;if(a=a.match(RegExp(wApp.cookie_name+"=(\\w+)\\;?")))c[d]=b[d]=a[1],c.session=b.session=JSON.parse(decodeURIComponent(Base64.decode(b[d]))),this.cookie=b,this.oldcookie=c,this.session=b.session;return b[d]},params:function(){return this.router.params}};
